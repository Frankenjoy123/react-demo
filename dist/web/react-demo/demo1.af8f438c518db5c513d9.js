	...
	var App = function (_Component) {
	  ...
	  function App(props) {
	    ...
	    _this.addItem = function () {
	      _this.setState({
	        items: _this.state.items.concat('Item ' + _this.state.items.length)
	      });
	    };
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'button',
	          { onClick: this.addItem, disabled: this.state.disabled },
	          'Add Item'
	        ),
	        _react2['default'].createElement(
	          'button',
	          { onClick: this.removeItem, disabled: this.state.disabled },
	          'Remove Item'
	        ),
	        _react2['default'].createElement(
	          'ul',
...
/***/ }
/******/ ]);
//# sourceMappingURL=demo1.af8f438c518db5c513d9.js.map