...
/***/ function(module, exports, __webpack_require__) {
	...
	var items = ['Item 0', 'Item 1']; /**
	                                   * Created by yzf on 16/5/16.
	                                   */
	
	
	function main() {
	  _reactDom2['default'].render(_react2['default'].createElement(_app2['default'], { items: items }), document.getElementById('content'));
	}
	        ...
	        _react2['default'].createElement(
	          ...
	          this.props.items.map(function (item) {
	            return _react2['default'].createElement(
	              ...
	              _react2['default'].createElement(_Input2['default'], { type: 'text', placeholder: item, ref: item }),
	              _react2['default'].createElement(
	                'button',
	                { className: _style2['default'].button, onClick: function onClick() {
	                    return _reactDom2['default'].findDOMNode(_this2.refs[item]).focus();
	                  } },
	                'focus ',
	                item
	              )
...
/***/ function(module, exports) {
	...
	module.exports = {"button":"react-demo-style-button-3Qfp2"};

/***/ }
/******/ ]);
//# sourceMappingURL=demo2.23a7468edfde5a587cfe.js.map