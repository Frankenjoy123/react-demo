...
/***/ function(module, exports, __webpack_require__) {
	...
	var _cookieParser = __webpack_require__(67);
	...
	var _gjj = __webpack_require__(110);
	
	var _gjj2 = _interopRequireDefault(_gjj);
	...
	function render(config, name) {
	  return __webpack_require__(109)("./" + name + '.html.est')(config);
	}
	...
	function main(assets) {
	  ...
	  app.use('/s', _express2['default']['static'](_path2['default'].resolve(process.cwd(), 'dist', 'web')));
	  app.use(_express2['default']['static'](_path2['default'].resolve(process.cwd(), 'images')));
	  app.use(_express2['default']['static'](_path2['default'].resolve(process.cwd(), 'lib')));
	  app.use('/', _bodyParser2['default'].json(), (0, _cookieParser2['default'])());
	
	  app.use('/:name', function (req, res) {
	    res.send(render(config, req.params.name));
	  });
	
	  _http2['default'].createServer(app).listen(config.port);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var tty = __webpack_require__(125);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var methods = __webpack_require__(30);
	var middleware = __webpack_require__(24);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var res = __webpack_require__(26);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var deprecate = __webpack_require__(4)('express');
	var isIP = __webpack_require__(57).isIP;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var merge = __webpack_require__(33);
	var sign = __webpack_require__(37).sign;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function View(name, options) {
	  ...
	  if (!opts.engines[this.ext]) {
	    // load engine
	    opts.engines[this.ext] = __webpack_require__(75)(this.ext.substr(1)).__express;
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	lazyProperty(module.exports, 'bufferConcat', function bufferConcat() {
	  return Buffer.concat || __webpack_require__(71)
	})
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(60).inherits
...
/***/ function(module, exports, __webpack_require__) {
	...
	var escapeHtml = __webpack_require__(9)
	  , parseRange = __webpack_require__(32)
	  , Stream = __webpack_require__(7)
	  , mime = __webpack_require__(45)
	  , fresh = __webpack_require__(28)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var cookie = __webpack_require__(69);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var map = {
		...
		"./express.js": 23,
		"./middleware/init": 24,
		"./middleware/init.js": 24,
		"./middleware/query": 15,
		"./middleware/query.js": 15,
		"./request": 25,
		"./request.js": 25,
		"./response": 26,
		"./response.js": 26,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    'gbk': {
	        type: '_dbcs',
	        table: function() { return __webpack_require__(34).concat(__webpack_require__(55)) },
	    },
	    'xgbk': 'gbk',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var provinces = ['浙江省', '北京市', '上海市'];
	var taskIds = ['21232f297a57a5a743894a0e4a801fc3'];
	var router = new _express.Router();
	
	router.post('/', function (req, res) {
	  var _req$query = req.query;
	  var parter_code = _req$query.parter_code;
	  var parter_key = _req$query.parter_key;
	  var province = _req$query.province;
	  var city_code = _req$query.city_code;
	  var login_type = _req$query.login_type;
	  var username = _req$query.username;
	  var password = _req$query.password;
	  var task_id = _req$query.task_id;
	
	  console.log(req.query);
	  if (parter_code == 'demo1' && parter_key == '21232f297a57a5a743894a0e4a801fc3') {
	    if (!provinces.find(function (item) {
...
/***/ function(module, exports) {
	...
	module.exports = function (scope) {
	  return "<!DOCTYPE html>\n<html>\n  <head>\n    <meta charset=\"utf-8\">\n    <title>demo1 动态增删</title>\n  </head>\n  <body>\n    <div id=\"content\"></div>\n    <script src=\"" + scope["static"] + "/react-demo/" + scope.assets.demo1.js + "\"></script>\n  </body>\n</html>\n";
	};
...
/***/ function(module, exports) {
	...
	module.exports = function (scope) {
	  return "<!DOCTYPE html>\n<html>\n  <head>\n    <meta charset=\"utf-8\">\n    <title>demo2 输入框聚焦</title>\n    <link rel=\"stylesheet\" type=\"text/css\" href=\"" + scope["static"] + "/react-demo/" + scope.assets.demo2.css + "\"></link>\n  </head>\n  <body>\n    <div id=\"content\"></div>\n    <script src=\"" + scope["static"] + "/react-demo/" + scope.assets.demo2.js + "\"></script>\n  </body>\n</html>\n";
	};
...
/***/ function(module, exports) {
	...
	module.exports = function (scope) {
	  return "<!DOCTYPE html>\n<html>\n  <head>\n    <meta charset=\"utf-8\">\n    <title>demo3 表单</title>\n    <link rel=\"stylesheet\" type=\"text/css\" href=\"" + scope["static"] + "/react-demo/" + scope.assets.demo3.css + "\"></link>\n    <link rel=\"stylesheet\" type=\"text/css\" href=\"" + scope["public"] + "/antd.min.css\"></link>\n  </head>\n  <body>\n    <div id=\"content\"></div>\n    <script src=\"" + scope["static"] + "/react-demo/" + scope.assets.demo3.js + "\"></script>\n  </body>\n</html>\n";
	};
...
/***/ }
/******/ ]);
//# sourceMappingURL=react-demo.25ca6356627c302b0fd0.js.map